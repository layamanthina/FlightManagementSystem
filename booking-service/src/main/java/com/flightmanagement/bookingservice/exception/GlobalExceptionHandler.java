...
import com.flightmanagement.bookingservice.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleBookingNotAllowed(BookingNotAllowedException ex) {
